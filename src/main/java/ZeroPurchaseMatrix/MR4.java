...
public class MR4 {
    //输入文件路径
    //private static String inPath = "/user/wzy/ContentRecommend/step3_output";
    private static String inPath = "ContentRecommend/step3_output/part-r-00000";
    //输出文件路径
    //private static String outPath = "/user/wzy/ContentRecommend/step4_output";
    private static String outPath = "ContentRecommend/step4_output";
    //设置缓存路径
    //这样让路径直接找输出矩阵所在的文件，它的别名才起作用
    //private static String cache = "/user/wzy/ContentRecommend/step2_input/";
    private static String cache = "ContentRecommend/step2_input/ItemUser.txt";
    //hdfs文件地址
